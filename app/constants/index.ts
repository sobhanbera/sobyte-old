...
export const DEFAULT_NOTIFICATION_IMAGE_SIZE = '300' // the size (width/height) of the image which will be shown in the notification of when a track is played short size of image would take less time to load and play the song faster then previously...
...
export const MAX_IMAGE_SIZE_TO_SHOW = 130 // width and height of the normal sized image which should be shown in the UI
